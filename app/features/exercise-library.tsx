...
const FILTERS = [
    ...
    { id: 'Dos', icon: 'human-handsup' }, 
    { id: 'Jambes', icon: 'walk' },
    { id: 'Épaules', icon: 'human-male' },
    { id: 'Bras', icon: 'arm-flex-outline' },
    { id: 'Abdominaux', icon: 'human-male-height-variant' }, 
    { id: 'Cardio', icon: 'run' }
];
...
export default function ExerciseLibraryScreen() {
  ...
  const openVideoDemo = (exerciseName: string) => {
      if (Platform.OS !== 'web') Haptics.selectionAsync();
      // Recherche intelligente : Nom de l'exo + "technique musculation" pour avoir des tutos
  ...
  const styles = StyleSheet.create({
    ...
    videoBtn: { 
        ...
        padding: 12, backgroundColor: '#ff000015', // Fond rouge très léger
        borderRadius: 12, borderWidth: 1, borderColor: '#ff000040' 
    },
    ...
    addBtn: { 
        ...
        borderRadius: 12, borderWidth: 1, borderColor: theme.colors.primary + '30' 
    },
