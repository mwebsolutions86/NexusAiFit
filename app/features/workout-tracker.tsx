...
export default function WorkoutTrackerScreen() {
  ...
  const styles = StyleSheet.create({
    ...
    textInput: { 
        ...
        color: theme.colors.text, padding: 15, height: 50 
    },
    ...
    badge: { 
        backgroundColor: theme.isDark ? 'rgba(0, 243, 255, 0.1)' : theme.colors.primary + '15', 
    ...
    exCardChecked: { 
        ...
        backgroundColor: theme.isDark ? 'rgba(74, 222, 128, 0.05)' : '#f0fdf4' 
    },
    ...
    checkbox: { 
        ...
        borderWidth: 2, borderColor: theme.colors.textSecondary, 
        justifyContent: 'center', alignItems: 'center' 
    },
    ...
    demoBtn: {
        ...
        backgroundColor: theme.isDark ? 'rgba(255,0,0,0.1)' : '#fee2e2',
        ...
        <View style={styles.dayContainer}>
            ...
            {currentDay.exercises.map((ex, index) => {
                ...
                return (
                    ...
                    >
                        <View style={{flex:1}}>
                            <Text style={[styles.exName, isChecked && {color: theme.colors.textSecondary, textDecorationLine:'line-through'}]}>
                                {ex.name}
                            </Text>
                            <View style={styles.exMetaRow}>
                                ...
                                <View style={styles.metaItem}>
                                    <MaterialCommunityIcons name="timer-outline" size={14} color={theme.colors.warning} />
