...
Ces mentions légales sont soumises au droit français.
  ...
  const styles = StyleSheet.create({
    ...
    sectionTitle: { color: theme.colors.primary, fontSize: 16, fontWeight: '900', marginBottom: 15, letterSpacing: 1 },
    sectionContent: { color: theme.colors.textSecondary, fontSize: 14, lineHeight: 22 }, // Légèrement augmenté la hauteur de ligne pour la lisibilité
